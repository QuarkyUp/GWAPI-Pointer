...
;~ Description: For older bots that still use structs. To be used with caution.
...
;~ Description: Custom Hook functions.
#include "gwAPI\Rendering_New.au3"

;~ Description: Obsctructed hook.
#include "gwAPI\ObsDetect.au3"