...
Global Const $HEADER_SKILL_USE_ALLY				= 0x4A	;Use Skill using sendpacket instead of asm call
Global Const $HEADER_SKILL_USE_FOE				= 0x4A	;Use Skill using sendpacket instead of asm call
Global Const $HEADER_SKILL_USE_ID				= 0x4A	;Use Skill using sendpacket instead of asm call
